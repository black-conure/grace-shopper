        ...
        {/* <Form>
          <Form.Group widths="equal">
            <Form.Field> */}
                ...
                <input onChange={this.handleChange} value={this.state.quantity} name="quantity" type="number" />
            {/* </Form.Field>
          </Form.Group>
        </Form> */}
        <Button
                  size='huge' color='blue' type="button" onClick={() => this.handleAddToCart(id, this.state.quantity)}
                >Add to Cart</Button>
      </Segment>
      )
